; (function ($) {
    ...
    $(document).ready(function () {
        if(window.screen.width<=991){
            $('._menu-item a').addClass('text-dark');
        }else{
            $('._menu-item a').addClass('text-white');
        }
        ...
        if ($(window).width() < 992) {
            ...
            $(".in-mobile ul li._menu-item").append('<i class="fas fa-chevron-right"></i>');
            $('<i class="fas fa-chevron-right"></i>').insertAfter("");

            $("._menu-item a").click(function(e) {
                // e.preventDefault();
        ...
        $( function() {
            $('._menu-item a').addClass('text-white')
            $('._menu-item').append('<style>.menu-item-has-children:before{color:#fff!important;}</style>');
    ...
    $(window).on("scroll", function() {
        ...
        if(window.screen.width<=991){
            if ($(window).scrollTop() >= 1) {
                ...
                $('._menu-item a').removeClass('text-white')
                $('._menu-item').append('<style>._menu-item:before{color:#000!important;}</style>');
                $('.readeal-top-logo a').html(`<img width="190px" src="/assets/img/logo-wb.png" alt="logo" />`)
                $('.sub-menu li a').addClass('text-dark');
                $('.sub-menu li a').removeClass('text-white');
            }
            else {
                mainMenuTop.removeClass('navbar-area-fixed');
                $('._menu-item a').addClass('text-dark')
                $('._menu-item').append('<style>.menu-item-has-children:before{color:#fff!important;}</style>');
                $('.readeal-top-logo a').html(`<img width="190px" src="/assets/img/logo-w.png" alt="logo" />`)
            }
